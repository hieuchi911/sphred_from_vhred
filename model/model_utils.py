...
def kl_weights_fn(global_step): # alpha*(global - anneal_bias/2) ---> alpha ~ anneal_bias = 25/10^((digits_in_bias - 1) round down by 0.5)
	return args['anneal_max'] * tf.sigmoid((0.025) * (
